...
//                        mToast.getLongDuration() : mToast.getShortDuration());
                long delayMillis = mToast.getDuration() == Toast.LENGTH_LONG ? mToast.getLongDuration()
                        : mToast.getDuration() == Toast.LENGTH_SHORT ? mToast.getShortDuration()
                        : Integer.MAX_VALUE;
                HANDLER.postDelayed(() -> cancel(), delayMillis);
                // 注册生命周期管控
